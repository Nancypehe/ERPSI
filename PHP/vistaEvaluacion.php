...
Pregunta 6:
<input type="text" name="pregunta6"><br>
Pregunta 7:
<input type="text" name="pregunta7"><br>
Pregunta 8:
<input type="text" name="pregunta8"><br>
Pregunta 9:
<input type="text" name="pregunta9"><br>
Pregunta 10:
<input type="text" name="pregunta10"><br>
...
if(isset($_POST["alta"])){
    ...
    echo"<h2>Evaluacion Guardada<h2>";
}
require_once("evaluacion.php");
$obj=new Evaluacion();
?>
